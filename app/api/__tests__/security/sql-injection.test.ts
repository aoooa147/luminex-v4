 ...
 * Tests for SQL injection prevention in API routes
 */
...
describe('Security: SQL Injection Prevention', () => {
  ...
  describe('process-referral endpoint', () => {
    it('should reject SQL injection in newUserId field', async () => {
    ...
    it('should reject SQL injection in referrerCode field', async () => {
      for (const payload of sqlInjectionPayloads) {
        const req = new NextRequest('http://localhost:3000/api/process-referral', {
          method: 'POST',
          body: JSON.stringify({
